    ...
    "Subworkflow": {
      ...
      "properties": {
        ...
        "aliases": {
          ...
          "description": "Alias names this subworkflow is imported as via `include { <NAME> as <ALIAS> }`. Calls retain the spelling used at each call site, while this field maps those aliases back to the canonical `name`. Empty when the subworkflow is never aliased."
        },
        "calls": {
          "type": "array",
          "items": {
