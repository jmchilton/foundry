...
export const summaryNextflowSchema = {
  ...
  "$comment": "Canonical source: packages/summary-nextflow-schema/src/summary-nextflow.schema.json in jmchilton/foundry. Mold frontmatter still cites this as `content/schemas/summary-nextflow.schema.json` for stability; the cast pipeline and Astro site resolve that ref back to this file at build time.",
